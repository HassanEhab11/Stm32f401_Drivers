...
static void GPIOx_AF(PORT_e Copy_ePortId, PIN_e Copy_ePinId, u8 Copy_u8AFval);
...
void MGPIO_vSetPIN_AF(PORT_e Copy_ePortId, PIN_e Copy_ePinId, u8 Copy_u8AFval, PIN_SPEED_e Copy_ePinSpeed)
{
	GPIOx_AF(Copy_ePortId, Copy_ePinId, Copy_u8AFval);
...
static void GPIOx_AF(PORT_e Copy_ePortId, PIN_e Copy_ePinId, u8 Copy_u8AFval)
{
	...
	if(Copy_ePinId <8)
	{
		GPIO_Port[Copy_ePortId]->AFRL &= ~((0b1111) << (4 * Copy_ePinId));
		GPIO_Port[Copy_ePortId]->AFRL |= ((Copy_u8AFval) << (4 * Copy_ePinId));
	}
	else if(Copy_ePinId < 16)
	{
		GPIO_Port[Copy_ePortId]->AFRL &= ~((0b1111) << (4 * Copy_ePinId % 8));
		GPIO_Port[Copy_ePortId]->AFRL |= ((Copy_u8AFval) << (4 * Copy_ePinId % 8));
	}
